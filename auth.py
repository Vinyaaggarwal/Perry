...
# UPDATED VERSION WITH LAST LOGIN FIX AND DATA PERSISTENCE
...
from data_manager import load_user_data, save_user_data, initialize_user_data
...
def logout_user():
    ...
    if 'user_email' in st.session_state:
        ...
        try:
            ...
            print(f"Error saving user data on logout: {str(e)}")
